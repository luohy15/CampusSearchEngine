...
//	private static String TXT_PATH = "/Users/rv/src/project/ImageSearch/DataParser/build";
	...
	private Document buildDocument(NamedNodeMap attrs) throws FileNotFoundException {
		...
		// body field
		String txtFilePath = TXT_PATH + "/" + attrs.getNamedItem("fn").getNodeValue() + ".txt"; 
	...
	public void indexSpecialFile(String filename) {
		try {
			...
			for (int i = 0; i < nodeList.getLength(); i++) {
				...
				System.out.println(" title= " + document.get("title") + " url= " + document.get("url"));
				// other stupid stuff
	...
	public static void main(String[] args) {
		FileIndexer indexer = new FileIndexer("fileIndex/index");
		indexer.indexSpecialFile("input/file.xml");
		indexer.saveGlobals("fileIndex/global.txt");
	}
}
